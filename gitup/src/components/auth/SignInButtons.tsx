    ...
    <Card className="p-6">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-background text-foreground border border-border rounded-lg hover:bg-accent transition"
          >
